...
public class ContextConfiguration {
    ...
    /*
     * 치환자(place-holder) 문법을 이용하여 properties에 저장된 key를 입력하면 value에 해당하는 값을 꺼내온다.
     *
     * 주의! 공백을 사용하면 값을 읽어오지 못한다.
     * 콜론(:)을 이용하면 값을 읽어오지 못하는 경우 사용할 대체값을 작성할 수 있다.
     */
...
//    private String carpBreadName2;
    ...
    @Bean
    public Product water(@Value("${beverage.water.name:그냥물}") String waterName,
